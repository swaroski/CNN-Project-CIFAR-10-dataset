...
class CifarHelper():
    ...
    def __init__(self):
        ...
        #grabs a list of all the test batches(actually just one batch)
        self.test_batch = [test_batch]
        
        # Initialize some empty variables for later use
    ...
    def set_up_images(self):
        ...
        #Reshapes & normalizes training images
        ...
        #Vertically stacks the images
        self.test_images = np.vstack([d[b"data"] for d in self.test_batch])
        test_len = len(self.test_images)
        
        #Reshapes & normalizes test images
